...
class BloomingtonSpider(scrapy.Spider):

	name = 'bloomington'

	urls = 'http://www.bloomingtonvolunteernetwork.org/agency/'
...
#		start_urls.append(url)
	...
	def parse(self,response):
		...
		for org in response.xpath('//*[@id="app-frame"]/div/div/section/div/div/table/tbody/tr[@class="agency "]/td[@class="details"]/a/@href').extract():
	...
	def parse_item(self,response):
		...
		'About Us': response.xpath('//section[@class="description"]/div[@class="section-inner"]/h4[text()="About Us "]/following-sibling::div[1]/p/text()').extract_first(),
